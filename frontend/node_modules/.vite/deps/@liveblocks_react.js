...
// node_modules/@liveblocks/react/dist/chunk-C65QJNZB.js
...
// node_modules/@liveblocks/react/dist/chunk-2R44HQCN.js
...
var UmbrellaStore = (_a4 = class {
  constructor(client) {
    ...
    __publicField(this, "unreadNotificationsCount");
    ...
    const unreadNotificationsCount = new DefaultMap(
      (queryKey) => {
        ...
        const resource = new SinglePageResource(async () => {
          const result = await __privateGet(this, _client).getUnreadInboxNotificationsCount({
            query
          });
...
function useAiChatStatus(chatId, branchId) {
  ...
  return useSignal(
    ...
    (result) => {
      ...
      if ((lastMessage == null ? void 0 : lastMessage.role) !== "assistant") return IDLE;
      ...
      if ((lastPart == null ? void 0 : lastPart.type) === "tool-invocation") {
        return {
          status: "generating",
        ...
        return { status: "generating", partType: lastPart == null ? void 0 : lastPart.type };
      }
    },
